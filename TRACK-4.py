...
def poly_decay(epoch):
 ...
 return alpha
########################### loading training ata and creating training set ################
TRAIN=[]
...
#############################################  loading validatio data      ##########

directory="FOUR_VALID_REAL_CLIPS"
...
for i in range(len(folders)):     
     ...
     print("len(VALID) after this folder", len(VALID))
...
with open("Tracker-4-model.json","w") as json_file:

...
def choose_and_load_tracked_movie():
    ...
    global frame_indicator
    frame_indicator=-2
    print("frame_indicator=",frame_indicator)
...
#################################################
def get_frame_info_fast_mode(internal_frame_number):# for manual segmentation correction
...
#############################################################
def erase_line_slow():# in case you are not happy with your hand contour and want to delete it
...
def erase_line(event):# in case you are not happy with your hand contour and want to delete it
    ...
    cell_contour_br=[]
##########################################################
def save_hand_drawing_for_one_cell_slow():
...
button_activate_fast_edit_mode = Button(frame3a_page5, text="3. Click to start fast correction", command=activate_fast_edit_mode,bg=button_color, font=all_font,activebackground="red")
...
edit_label_slow = tk.Label(frame3b_page5, text=" SLOW edit mode: by hand drawing",
                          fg="black",bg=label_color, font='TkDefaultFont 10 bold').pack(pady=5)
button_activate_slow_edit_mode = Button(frame3b_page5, text="4. Click to start hand drawing",  command=activate_slow_edit_mode,bg=button_color, font=all_font,activebackground="red")
button_activate_slow_edit_mode.pack(side=tk.LEFT, padx=10,pady=5)

button_activate_hand_drawing_mode_for_one_cell = Button(frame3b_page5, text="4a. Start drawing with mouse",command=activate_hand_drawing_mode_for_one_cell,bg=button_color, font=all_font,activebackground="red")
button_activate_hand_drawing_mode_for_one_cell.pack(side=tk.LEFT, padx=5,pady=5)

button_save_hand_drawing_for_one_cell = Button(frame3b_page5, text="4b. Save hand drawing", command=save_hand_drawing_for_one_cell,bg=button_color, font=all_font,activebackground="red")
button_save_hand_drawing_for_one_cell.pack(side=tk.LEFT, padx=10,pady=5)
###################################################################

##################################################################

button_save_frame = Button(frame7_page5, text="6. Save edits \nfor current frame", command=save_edits_for_frame,bg=button_color, font=all_font,activebackground="red")
button_save_frame.pack(pady=5)

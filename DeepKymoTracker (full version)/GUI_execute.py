...
def stop_editing_division():
    ...
    print("mother_number=", mpther_number)
    ...
    m_in_mask=int(np.max(mask_prev_frame))
    m=int(math.log(round(m_in_mask),2))
    print("m=", m)
    ###################################
    ...
    print("curr_frame_cell_names middle=",curr_frame_cell_names)

...
def select_one_bright():    
    ...
    photo_clicked=turn_image_into_tkinter(clicked_bright, 382)
...
####################################################  
global text, variable_stop, manual_division_indicator, mother_number, edit_id_indicator
text, variable_stop, manual_division_indicator, mother_number, edit_id_indicator=StringVar(), "Do not stop", StringVar(), IntVar(),StringVar()
...
button_magnify = Button(frame8_page4, text="7. Magnify current frame",activebackground="red", font='TkDefaultFont 10 bold', 
